...
class IssuesTable extends React.Component {
    ...
    componentDidMount() {
        this.setState({
            daily: this.props.dailyIssues.dailyIssues
        });
        this.createSelected(this.props.categorySelection);
        // this.createDuration();
        // this.createColumnHeaders(this.props.dailyIssues.dailyIssues);
    ...
    componentDidUpdate(prevProps, prevState) {
        if(prevProps.dailyIssues.dailyIssues !== this.props.dailyIssues.dailyIssues) {
            this.setState({
                daily: this.props.dailyIssues.dailyIssues
            });
            // this.createColumnHeaders(this.props.dailyIssues)
        }
            ...
            if(this.props.dailyCollapsible.collapsibleValue.includes('All')) {
                return(
                    <div id="daily_table">
                        ...
                        <div>
                            {
                                this.state.daily && this.state.selected[0] in this.state.daily['Latest Result'] ? Object.keys(this.state.daily['Latest Result'][this.state.selected[0]]).map(subcat => {
                                    return (
                                        <div>
                                                                                    ...
                                                                                    return (
                                                                                        this.state.daily['Daily Report Column Headers'][item].map(val => {
                                                                                            if(item !== 'VESSEL POSITION') {
                                                                                                if(val === 'Reported' || val === 'Expected' || val === 'Unit' || val === 'API_DATA' || val === 'Charter Pty' || val === 'Calculated' || val === 'Threshold' || val === 'Occurrence') {
                                                                                                    return (
                                                                                                ...
                                                                                                if(val === 'Statement') {
                                                                                                    return (
                                                                                                        <th key={val} style={{width: "40%", textAlign: 'center'}}>{val}</th>
                                                                                                    )
                                                                                                }
                                                                                                else {
                                                                                                    return (
                                                                                ...
                                                                                Object.keys(subcategoryObj).map(subcategory => {
                                                                                    ...
                                                                                    if(subcatname === subcategory && subcategoryObj[subcategory].length > 0) {
                                                                                                    ...
                                                                                                    if(item['equipment_type'] === 'E') {
                                                                                                        return (
                                                                                                            <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                ...
                                                                                                                <td style={{color: '#006400'}}><i>{item['frequency']}</i></td>
                                                                                                    ...
                                                                                                    if(typeof item['within_outlier_limits'] === typeof undefined) {
                                                                                                        ...
                                                                                                        return (
                                                                                                            <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                ...
                                                                                                                <td style={{color: 'red'}}>{item['frequency']}</td>
                                                                                                        ...
                                                                                                        return (
                                                                                                            <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                ...
                                                                                                                <td style={{color: 'orange'}}>{item['frequency']}</td>
                                                                                                            ...
                                                                                                            if('spe_messages' in item && this.state.durationActual in item['spe_messages'] && item['spe_messages'][this.state.durationActual][2] !== null) {
                                                                                                                ...
                                                                                                                return (
                                                                                                                    <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                        ...
                                                                                                                        <td style={{color: 'violet'}}>{item['frequency']}</td>
                                                                                                        ...
                                                                                                        if(item['equipment_type'] === 'E') {
                                                                                                            return (
                                                                                                                <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                    ...
                                                                                                                    <td style={{color: '#006400'}}><i>{item['unit']}</i></td>
                                                                                                                    <td style={{color: '#006400'}}><i></i></td>
                                                                                                                    <td style={{color: '#006400'}}><i>{this.props.dailyIssues.dailyIssues['Charter Party Values'][item['identifier']]}</i></td>
                                                                                                                    <td style={{color: '#006400'}}><i>{this.props.dailyIssues.dailyIssues['Charter Party Prediction Values'][item['identifier']]}</i></td>
                                                                                                                    <td style={{color: '#006400'}}><i>{this.props.dailyIssues.dailyIssues['Static Data'][tempName]}</i></td>
                                                                                                                    <td style={{color: '#006400'}}><i>{this.props.dailyIssues.dailyIssues['Compliance Messages']}</i></td>
                                                                                                                </tr>
                                                                                                            )
                                                                                                        }
                                                                                                        if(typeof item['within_outlier_limits'] === typeof undefined) {
                                                                                                            return (
                                                                                                                <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                    <td>{item['name']}</td>
                                                                                                                    <td>{item['unit']}</td>
                                                                                                                    <td>{this.props.dailyIssues.dailyIssues['Charter Party Values'][item['identifier']]}</td>
                                                                                                                    <td>{item['frequency']}</td>
                                                                                                                    <td>{this.props.dailyIssues.dailyIssues['Charter Party Prediction Values'][item['identifier']]}</td>
                                                                                                                    <td>{this.props.dailyIssues.dailyIssues['Static Data'][tempName]}</td>
                                                                                                                    <td>{this.props.dailyIssues.dailyIssues['Compliance Messages']}</td>
                                                                                                                </tr>
                                                                                                            )
                                                                                                        }
                                                                                                        else if(item['within_outlier_limits'][this.state.durationActual] === false) {
                                                                                                            return (
                                                                                                                <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                    <td style={{color: 'red'}}>{item['name']}</td>
                                                                                                                    <td style={{color: 'red'}}>{item['unit']}</td>
                                                                                                                    <td style={{color: 'red'}}>{this.props.dailyIssues.dailyIssues['Charter Party Values'][item['identifier']]}</td>
                                                                                                                    <td style={{color: 'red'}}>{item['frequency']}</td>
                                                                                                                    <td style={{color: 'red'}}>{this.props.dailyIssues.dailyIssues['Charter Party Prediction Values'][item['identifier']]}</td>
                                                                                                                    <td style={{color: 'red'}}>{this.props.dailyIssues.dailyIssues['Static Data'][tempName]}</td>
                                                                                                                    <td style={{color: 'red'}}>{this.props.dailyIssues.dailyIssues['Compliance Messages']}</td>
                                                                                                                </tr>
                                                                                                            )
                                                                                                        }
                                                                                                        else if(typeof item['within_operational_limits'] === typeof undefined) {
                                                                                                            ...
                                                                                                            return (
                                                                                                                <tr key={item['identifier']} style={{textAlign: "center"}}>
                                                                                                                    <td style={{color: 'orange'}}>{item['name']}</td>
                                                                                                                    <td style={{color: 'orange'}}>{item['unit']}</td>
                                                                                                                    <td style={{color: 'orange'}}>{this.props.dailyIssues.dailyIssues['Charter Party Values'][item['identifier']]}</td>
                                                                                                                    <td style={{color: 'orange'}}>{item['frequency']}</td>
                                                                                                                    <td style={{color: 'orange'}}>{this.props.dailyIssues.dailyIssues['Charter Party Prediction Values'][item['identifier']]}</td>
                                                                                                                    <td style={{color: 'orange'}}>{this.props.dailyIssues.dailyIssues['Static Data'][tempName]}</td>
                                                                                                                    <td style={{color: 'orange'}}>{this.props.dailyIssues.dailyIssues['Compliance Messages']}</td>
                                                                                                                </tr>
                                                                                                            )
                                                                                                        }
                                                                                                        else {
                                                                                        ...
                                                                                        return (
                                                                                            <tr>
                                                                                                {
                                                                                                    // this.props.dailyIssues.dailyIssues && <td colSpan={this.props.dailyIssues.dailyIssues['Daily Report Header Columns'][this.state.selected[0]].length - 1}>No Data Found!</td>
                                                                                                }
                                                                                            </tr>
                                                                                        )
                                                                                    }
                ...
                return(
                    <div id="daily_table">
                        ...
                        <div>
                            {
                                this.state.daily && this.state.selected[0] in this.state.daily['Latest Result'] ? <Table bordered hover style={{width: "100%", wordWrap: "break-word", tableLayout: "fixed"}} size="sm">
                                    {
                                        Object.keys(this.state.daily['Latest Result']).map(category => {
                                            if(category === this.state.selected[0]) {
                                                return (
